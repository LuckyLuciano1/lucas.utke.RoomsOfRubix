...
void Tile::Render()
{
	for (int a = 0; a < z / boundY; a++) {
		al_draw_tinted_scaled_rotated_bitmap_region(image, 0, 200, imageboundX, imageboundY, transparency, boundX / 2, boundY / 2, x, y + z + (a*boundY), boundX / imageboundX, boundY / imageboundY, angle, FlipHorizontal);
